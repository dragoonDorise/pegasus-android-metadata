...
echo "### Update: git reset "  &>> ~/storage/shared/pegasus_installer_log.log
git pull &>> ~/storage/shared/pegasus_installer_log.log 
echo "### Update: git pull "  &>> ~/storage/shared/pegasus_installer_log.log
...
echo "### Update: cp .sh "  &>> ~/storage/shared/pegasus_installer_log.log
