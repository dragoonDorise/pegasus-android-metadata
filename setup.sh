...
if [ hasRedDream==true ]; then
	...
	echo "Type Y and press the A Button if you want to install it. A link to the Play Store will open"
	read pause
...
if [ hasDrastic==true ]; then
	...
	echo -e  "${RED}Not installed${NONE}"
	echo "Type Y and press the A Button if you want to install it."
	read pause
...
echo -e "${BOLD}If you chose to not install the emulator, remember that you need them if you want to play those systems${NONE}"
