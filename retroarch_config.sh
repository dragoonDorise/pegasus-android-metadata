...
sed -i 's/menu_show_load_content_animation = "true"/menu_show_load_content_animation = "false"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_autoconfig = "true"/notification_show_autoconfig = "false"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_config_override_load = "true"/notification_show_config_override_load = "false"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_refresh_rate = "true"/notification_show_refresh_rate = "false"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_remap_load = "true"/notification_show_remap_load = "false"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_screenshot = "true"/notification_show_screenshot = "false"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_set_initial_disk = "true"/notification_show_set_initial_disk = "false"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_patch_applied = "true"/notification_show_patch_applied = "false"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
#sed -i 's/video_scale_integer = "false"/video_scale_integer = "true"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_menu_toggle_gamepad_combo = "0"/input_menu_toggle_gamepad_combo = "6"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_enable_hotkey_btn = "nul"/input_enable_hotkey_btn = "109"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_exit_emulator_btn = "nul"/input_exit_emulator_btn = "108"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_load_state_btn = "nul"/input_load_state_btn = "102"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_menu_toggle_gamepad_combo = "nul"/input_menu_toggle_gamepad_combo = "6"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_rewind_btn = "nul"/input_rewind_btn = "104"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_save_state_btn = "nul"/input_save_state_btn = "103"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_state_slot_decrease_btn = "nul"/input_state_slot_decrease_btn = "h0down"/g' ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
...
cp ~/storage/shared/Android/data/${raPath}/files/retroarch.cfg ~/storage/shared/Retroarch/config/custom-retroarch.cfg

sed -i 's/config_save_on_exit = "true"/config_save_on_exit = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_overlay_enable = "true"/input_overlay_enable = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/menu_show_load_content_animation = "true"/menu_show_load_content_animation = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_autoconfig = "true"/notification_show_autoconfig = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_config_override_load = "true"/notification_show_config_override_load = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_refresh_rate = "true"/notification_show_refresh_rate = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_remap_load = "true"/notification_show_remap_load = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_screenshot = "true"/notification_show_screenshot = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_set_initial_disk = "true"/notification_show_set_initial_disk = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/notification_show_patch_applied = "true"/notification_show_patch_applied = "false"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
#sed -i 's/video_scale_integer = "false"/video_scale_integer = "true"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_menu_toggle_gamepad_combo = "0"/input_menu_toggle_gamepad_combo = "6"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_enable_hotkey_btn = "nul"/input_enable_hotkey_btn = "109"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_exit_emulator_btn = "nul"/input_exit_emulator_btn = "108"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_load_state_btn = "nul"/input_load_state_btn = "102"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_menu_toggle_gamepad_combo = "nul"/input_menu_toggle_gamepad_combo = "6"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_rewind_btn = "nul"/input_rewind_btn = "104"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_save_state_btn = "nul"/input_save_state_btn = "103"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_state_slot_decrease_btn = "nul"/input_state_slot_decrease_btn = "h0down"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_state_slot_increase_btn = "nul"/input_state_slot_increase_btn = "h0up"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/input_toggle_fast_forward_btn = "nul"/input_toggle_fast_forward_btn = "105"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
sed -i 's/menu_driver = "glui"/menu_driver = "ozone"/g' ~/storage/shared/Retroarch/config/custom-retroarch.cfg &>> ~/storage/shared/pegasus_installer_log.log 
